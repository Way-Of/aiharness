#!/usr/bin/env python3
"""Compile ticket-organization SKILL.md for all 6 AI coding tools.
...
CANONICAL_DESCRIPTION = (
    "Proactively organize tickets across all namespaces \u2014 auto-audit, "
    "archive management, naming enforcement, orphan detection, "
    "cross-project consistency, TODO.md regeneration"
)
...
def main():
    parser = argparse.ArgumentParser(description="Compile ticket-organization SKILL.md for all tools")
